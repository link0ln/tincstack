      ...
      - [x] 🟡 Measured again 2026-09-24 (`android-emulator-test.sh`): curl
        ...
        **Fixed 2026-09-24 (owner: "patch ngtcp2 for curl's transport
        ...
        - [ ] 🟠 **The listener's QUIC side is not nginx's** (was 🟡
          ...
          handshake fix (`.../2026-09-25-quic-handshake/`); the other 5
          are open.
          ...
          - [ ] 🟡 **A POST's 405 comes after its body, nginx's right after
            ...
            owner's call.
          - [ ] 🟢 **If SETTINGS ever announce a QPACK dynamic table** (nginx
          ...
          - [ ] 🟡 **What a prober reads after a handshake.** Transport
