#ifndef TINC_H3_HUFFMAN_H
#define TINC_H3_HUFFMAN_H

/* HPACK Huffman code (RFC 7541 Appendix B), shared by QPACK (RFC 9204 4.1.2):
   code and bit length of symbols 0..255 and EOS (256). Generated from the
   table in python-hyper's hpack (huffman_constants.py); prefix-free and
   complete (Kraft sum 1) -- checked when generated. */
